...
1. **Provision the box.** SSH in; run `bash <(curl -fsSL https://raw.githubusercontent.com/zed-ai/suna/main/scripts/zed-selfhost-up.sh) --domain <domain> --email ops@<domain>`. This installs Docker, runs `zed self-host init`, and starts the stack.
