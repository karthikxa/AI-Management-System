...
export const zedTerraformIacSurface: MatcherPlugin = {
  slug: "zed-terraform-iac-surface",
  description: "Zed Terraform/IaC files for cloud security review coverage",
  noiseTier: "noisy",
  ...
  match(content, filePath): CandidateMatch[] {
    ...
    for (let i = 0; i < lines.length; i++) {
      ...
      matches.push({
        vulnSlug: "zed-terraform-iac-surface",
        lineNumbers: [i + 1],
