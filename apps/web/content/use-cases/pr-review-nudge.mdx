...
description: The pull-request review agent we run on Zed — it flags PRs stuck past a review SLA, gone stale, or sitting on unaddressed change requests, then nudges the author or reviewer in Slack with exactly what's blocking.
date: "2026-03-14"
author: team
tags:
  - Engineering
...
We run a PR review nudge agent on Zed that reads every open pull request
...
On Zed, a daily cron triggers an agent. It spawns a fresh session with
