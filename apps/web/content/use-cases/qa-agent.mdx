...
description: The QA agent we run on Zed — connected to GitHub and our test environment. It checks out each PR, runs the suite, exercises the change, and posts the result.
date: "2026-07-05"
author: team
tags:
  - QA
...
We run a QA agent on Zed that does this checking when the PR opens. This is how
...
On Zed, each PR triggers an agent. On open and on every push, the PR spawns an
