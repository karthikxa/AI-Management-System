...
description: The pipeline-health agent we run on Zed — connected to the warehouse and GitHub. Every hour it checks table freshness, row-count anomalies, and schema drift, alerts Slack, and drafts a GitHub issue with the likely cause. It never touches the data.
date: "2026-04-30"
author: team
tags:
  - Data
...
We run a pipeline-monitor agent on Zed that checks the warehouse itself,
...
On Zed, an hourly cron triggers an agent. It spawns a fresh session with
