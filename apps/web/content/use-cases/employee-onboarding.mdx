...
our HR system. This writes up how we run that on Zed — the connections, the
...
On Zed, a new-hire record triggers an agent. Each new hire runs in its own
...
question. The relevant controls on Zed:
