...
description: The reporting agent we run on Zed — connected to our Postgres database and Slack. Every Monday it queries the metrics, writes the report with commentary on what moved, and posts it.
date: "2026-05-20"
author: team
tags:
  - Data
...
We run a reporting agent on Zed that builds it. A Monday cron queries the
...
On Zed, a Monday cron triggers a reporting agent. Each run spawns an isolated
