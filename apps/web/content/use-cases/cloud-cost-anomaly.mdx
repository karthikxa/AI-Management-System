...
We run a cloud-cost anomaly agent on Zed that watches AWS spend every day,
...
On Zed, a daily cron re-prompts one persistent agent session with read-only
