...
We run an agent on Zed that does the first read consistently. Each application
...
On Zed, each inbound application triggers an agent. The application spawns an
