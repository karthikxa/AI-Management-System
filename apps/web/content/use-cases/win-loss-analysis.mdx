...
description: The win-loss agent we run on Zed — a weekly cron reads every HubSpot deal closed-won or closed-lost since the last run and posts the patterns by segment, competitor, price, and stage of death to Slack.
date: "2026-05-16"
author: team
tags:
  - Sales
...
We run a win-loss analysis agent on Zed that reads closed deals from
...
On Zed, a weekly cron triggers an agent. It spawns a fresh session (a cloud
