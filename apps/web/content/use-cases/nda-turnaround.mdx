...
description: The NDA agent we run on Zed — every 15 minutes it reviews a new inbound NDA against our standard playbook, redlines the non-standard terms in the document, and drafts a flag summary for counsel. It never signs or sends; counsel does.
date: "2026-07-04"
author: team
tags:
  - Legal
...
We run an NDA-turnaround agent on Zed that watches for inbound NDAs and gives
...
On Zed, a **cron** fires every 15 minutes and checks a watched Gmail label
