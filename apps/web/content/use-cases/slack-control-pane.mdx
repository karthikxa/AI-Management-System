...
Zed, and the same setup works for any team.
...
To give the agent a new capability, you **connect the platform to Zed once**.
...
<Callout title="The setup" tone="accent">
  Connect Slack as the **channel**, connect each platform to Zed as a scoped
