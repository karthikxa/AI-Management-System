...
description: The docs agent we run on Zed — connected to GitHub and our codebase. Once a day it checks the code that landed since its last run and updates the docs those changes affected, opening a PR for review.
date: "2026-07-05"
author: team
tags:
  - Documentation
...
that on Zed — the connections, the steps, and the guardrails — so you can set
...
On Zed, a docs agent runs once a day in the same persistent session — a
