...
We run an NPS analysis agent on Zed that reads new survey responses every week
...
On Zed, a weekly cron triggers an agent. It spawns an isolated session (a cloud
