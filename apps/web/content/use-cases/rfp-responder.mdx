...
description: The RFP-responder agent we run on Zed — connected to the inbound RFP and our vetted answer library. It parses each question, drafts a response in a new Google Doc from the library and our product docs, and flags anything it can't answer confidently for a human to review before it goes out.
date: "2026-06-19"
author: team
tags:
  - Sales
...
We run an RFP-responder agent on Zed that drafts the response from our vetted
...
On Zed, a cron checks the inbox every 15 minutes for a new RFP or proposal
