...
description: The interview-scheduling agent we run on Zed — daily, it finds candidates ready to schedule in Greenhouse, checks interviewer availability on Google Calendar, and drafts a slot proposal to the candidate and the calendar invites for a coordinator to confirm.
date: "2026-06-20"
author: team
tags:
  - HR
...
We run an interview-scheduling agent on Zed that does the coordination every
...
On Zed, a daily cron triggers an agent. It spawns a fresh session (a cloud
