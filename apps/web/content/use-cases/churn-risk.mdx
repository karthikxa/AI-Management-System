...
We run a churn-risk agent on Zed that reads those signals every day and posts a
...
On Zed, a daily cron triggers an agent. It spawns an isolated session (a cloud
