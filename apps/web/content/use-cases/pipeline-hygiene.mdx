...
description: The pipeline-hygiene agent we run on Zed — it scans HubSpot every day for stale deals, missing next steps, deals stalled in a stage, and overdue tasks, nudges the owning rep in Slack, and escalates the worst offenders to their manager.
date: "2026-05-06"
author: team
tags:
  - Sales
...
We run a pipeline-hygiene agent on Zed that reads HubSpot every day and
