...
description: The social-scheduler agent we run on Zed — a daily agent that reads our Notion content calendar, drafts platform-appropriate posts for upcoming content, launches, and announcements, and holds them in Slack with the scheduled date for a human to approve and publish.
date: "2026-04-25"
author: team
tags:
  - Marketing
...
We run a social-scheduler agent on Zed that closes that gap every day. It
...
On Zed, a daily cron triggers an agent. It spawns a fresh session that
