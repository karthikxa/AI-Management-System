...
description: The inbox agent we run on Zed — connected to Gmail, a help doc, and Linear. It labels every inbound email, drafts a reply, or files a task, and stops for approval before anything goes to a customer.
date: "2026-03-04"
author: team
tags:
  - Support
...
run that on Zed — the connections, the steps, and the guardrails.
...
Our shared inbox in **Gmail** is connected to an agent running on Zed. Every
...
convenience one. The relevant controls on Zed:
