...
description: The QBR-prep agent we run on Zed — connected to Postgres, HubSpot, Google Slides, and Google Docs. Weekly, for every account due a quarterly business review, it pulls usage trends, account health, support activity, and expansion signals into a draft deck and briefing doc for the CSM to review and present.
date: "2026-05-20"
author: team
tags:
  - Customer Success
...
We run a QBR-prep agent on Zed that does that assembly every week. It reads
...
On Zed, a weekly cron triggers an agent. It spawns an isolated session with
