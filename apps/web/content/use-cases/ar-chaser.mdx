...
description: An accounts-receivable agent we run on Zed — connected to Stripe, email, and the accounting ledger. It finds overdue invoices, sends the right reminder, logs every touch, and reconciles when payment lands.
date: "2026-02-11"
author: team
tags:
  - Finance
...
We run an accounts-receivable agent on Zed that does this chasing on a daily
...
On Zed, a daily cron triggers an agent. Each morning it spawns an isolated
