...
description: The ticket-to-KB agent we run on Zed — clusters resolved Plain support tickets for recurring questions with no matching help-center article, drafts the top gaps as real articles from the actual resolutions, and opens a PR for a human to review and publish.
date: "2026-04-12"
author: team
tags:
  - Support
...
We run a ticket-to-KB agent on Zed that reads our resolved Plain tickets
...
On Zed, a weekly cron re-prompts the same persistent session — a cloud
