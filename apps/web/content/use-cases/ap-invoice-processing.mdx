...
We run an accounts-payable agent on Zed that checks the inbox every 15 minutes,
...
On Zed, a cron fires every 15 minutes. Each firing spawns a fresh agent
