...
description: A monthly agent we run on Zed — connected to Postgres, Stripe, and last month's update. It pulls the core metrics, compares them to last month and to plan, and drafts the update in our format for a founder to finalize.
date: "2026-03-04"
author: team
tags:
  - Finance
...
We run an agent on Zed that does the gathering and the first draft. This is how
...
On Zed, a monthly cron triggers an agent. It spawns an isolated session (a
