...
description: The finance agent we run on Zed — connected to Stripe, the bank feed, and Google Sheets. Each month it matches transactions against invoices, flags mismatches, and posts a summary, escalating anything it can't match.
date: "2026-04-15"
author: team
tags:
  - Finance
...
how we run that on Zed — the connections, the steps, and the guardrails.
...
On Zed, a monthly **cron** triggers a reconciliation agent. Each run spawns
