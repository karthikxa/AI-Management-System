...
description: The SaaS spend audit agent we run on Zed — reconciles recurring card and bank charges against our subscription register every week and flags duplicate tools, unused seats, price hikes, and shadow IT, recommending only — it never touches a subscription.
date: "2026-04-15"
author: team
tags:
  - Finance
...
We run a SaaS spend audit agent on Zed that reconciles our card and bank
...
On Zed, a weekly **cron** re-prompts a persistent agent **session**. It
