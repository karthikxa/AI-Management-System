...
We run an escalation-manager agent on Zed that checks the Plain queue every
...
On Zed, a cron fires every 15 minutes and spawns a fresh agent session. It
