...
description: The renewal manager we run on Zed — a daily cron that surfaces every account 90, 60, and 30 days from renewal, preps a packet on usage and value delivered, drafts outreach, and flags at-risk accounts for the owner to review.
date: "2026-05-28"
author: team
tags:
  - Sales
...
We run a renewal manager agent on Zed that watches every HubSpot deal's
...
On Zed, a daily cron triggers an agent that reads every HubSpot deal's
