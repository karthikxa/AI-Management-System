...
description: The sales agent we run on Zed — connected to HubSpot, email, and Google Calendar. It researches each new lead, drafts a personalized follow-up, and offers a call slot, with a human approving the send.
date: "2026-03-18"
author: team
tags:
  - Sales
...
Our lead pipeline in **HubSpot** is connected to an agent running on Zed.
...
a sales one. The relevant controls on Zed:
