...
description: The lead-routing agent we run on Zed — every 15 minutes it scores each new HubSpot lead, assigns it to the right rep by territory, segment, or round-robin, and notifies the rep in Slack, flagging anything ambiguous for a human instead of guessing.
date: "2026-04-18"
author: team
tags:
  - Sales
...
We run a lead-routing agent on Zed that does exactly that check, every 15
...
On Zed, a cron fires an agent every 15 minutes. It spawns a fresh session
