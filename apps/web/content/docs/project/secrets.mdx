---
title: Secrets
description: How Zed stores, injects, and rotates encrypted project credentials.
---
...
[connector](/docs/connect/connectors), not a session. Zed resolves it
...
and save. Zed encrypts the value immediately.
</Step>

<Step>
### Grant it to an agent

Add the identifier to the agent's `secrets` list in `zed.yaml`. A
