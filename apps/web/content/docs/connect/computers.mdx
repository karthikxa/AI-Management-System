---
title: Computers
description: A computer connects your own machine to Zed through a permissioned tunnel.
---
...
You configure Computers profiles from the dashboard, not from `zed.yaml`.
