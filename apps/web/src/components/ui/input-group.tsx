  ...
  return (
    <div
      ...
      className={cn(
        ...
        // Focus state.
        'has-[[data-slot=input-group-control]:focus-visible]:border-zed-blue has-[[data-slot=input-group-control]:focus-visible]:border has-[[data-slot=input-group-control]:focus-visible]:outline-none',
