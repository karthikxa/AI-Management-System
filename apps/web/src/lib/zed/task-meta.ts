 ...
 *
 * Mirrors the canonical task statuses exposed by the live /zed/tasks API.
 */
...
/** Canonical task statuses (inlined; formerly from the /zed/tasks board API). */
...
export const STATUS_META: Record<ZedTaskStatus, StatusMeta> = {
  todo: {
    icon: Circle,
...
export const ALL_STATUSES: ZedTaskStatus[] = [
  'todo',
  'in_progress',
  'input_needed',
  'awaiting_review',
