/**
 * Zed-cloud-only feature flags.
 *
 * These gate UI that's specific to the Zed-hosted cloud frontend and
 ...
 *
 * Enable on the cloud frontend with: NEXT_PUBLIC_ZED_PERSONAL_CONTACT=true
 *
...
export const SHOW_PERSONAL_CONTACT =
  process.env.NEXT_PUBLIC_ZED_PERSONAL_CONTACT === 'true';
