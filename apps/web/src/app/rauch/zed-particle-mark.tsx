...
/**
 * A Rauch-style hard-pixel particle canvas that resolves into the Zed
 * brandmark, then lets pointer/touch movement disturb and settle the mark.
 */
export function ZedParticleMark() {
  ...
  return (
    <canvas
      ref={canvasRef}
      aria-label="Zed symbol rendered as hard subpixel particles"
