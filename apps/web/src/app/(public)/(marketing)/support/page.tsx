      ...
      <div className="mx-auto max-w-3xl px-6 pt-24 pb-24 sm:pt-32 sm:pb-32">
        ...
        <Reveal delay={0.08}>
          <p className="text-muted-foreground max-w-xl text-base leading-relaxed">
            ...
            <a href="mailto:support@zed.com" className={linkClass}>
              {tHardcodedUi.raw('appHomeSupportPage.line63JsxTextSupportZedCom')}
            </a>
            .{' '}
            {tHardcodedUi.raw(
        ...
        <Reveal>
          <div className="mt-14">
            ...
            <div>
              <FAQItem
                question={tHardcodedUi.raw('appHomeSupportPage.line76JsxAttrQuestionWhatIsZed')}
              ...
              <FAQItem
                question={tHardcodedUi.raw(
                  'appHomeSupportPage.line80JsxAttrQuestionHowIsZedDifferentFromOtherAiPlatforms',
                )}
                answer={tHardcodedUi.raw(
              ...
              <FAQItem
                question={tHardcodedUi.raw(
                  'appHomeSupportPage.line84JsxAttrQuestionCanZedConnectToMyApps',
                )}
                answer={tHardcodedUi.raw(
              ...
              <FAQItem
                ...
                answer={
                  <>
                    Email{' '}
                    <a href="mailto:support@zed.com" className={linkClass}>
                      {tHardcodedUi.raw('appHomeSupportPage.line90JsxTextSupportZedCom')}
                    </a>
                    {tHardcodedUi.raw(
              ...
              <FAQItem
                ...
                answer={
                  <>
                    Contact{' '}
                    <a href="mailto:support@zed.com" className={linkClass}>
                      {tHardcodedUi.raw('appHomeSupportPage.line96JsxTextSupportZedCom')}
                    </a>
                    {tHardcodedUi.raw(
        ...
        <Reveal>
          <div ref={accountDeleteRef} id="account-delete" className="mt-14">
            ...
            <p className="text-muted-foreground mb-4 text-base leading-relaxed">
              ...
              <a href="mailto:support@zed.com" className={linkClass}>
                {tHardcodedUi.raw('appHomeSupportPage.line111JsxTextSupportZedCom')}
              </a>{' '}
        ...
        <Reveal>
          <div className="border-border mt-14 border-t pt-8">
            ...
            <div className="mt-3 flex flex-col gap-1.5">
              <a href="mailto:support@zed.com" className={`text-base ${linkClass} w-fit`}>
                {tHardcodedUi.raw('appHomeSupportPage.line154JsxTextSupportZedCom')}
              </a>
              <a href="mailto:security@zed.com" className={`text-base ${linkClass} w-fit`}>
                {tHardcodedUi.raw('appHomeSupportPage.line157JsxTextSecurityZedCom')}
              </a>
            </div>
          </div>
        </Reveal>
