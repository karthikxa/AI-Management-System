...
export const metadata: Metadata = {
  ...
  keywords:
    'Zed careers, Zed jobs, AI startup jobs, open AGI platform, agent engineering, San Francisco AI jobs, Belgrade AI jobs, startup hiring',
  openGraph: {
    title: 'Careers at Zed – Open positions',
    description: DESCRIPTION,
