 ...
 * explanation, and the two ways out: upgrade to a Zed plan, or bring an API
  ...
  return (
    <>
      ...
      <EmptyState
        ...
        description={
          showUpgradeOption
            ? "This session needs an LLM connected before it can respond. Upgrade for instant access to Zed's managed models, or bring your own API key from any provider."
