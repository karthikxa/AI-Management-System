...
const ASSETS: ReleaseAsset[] = [
  { name: 'Zed-0.11.0-universal-mac.zip', url: 'u/zip', size: 197_650_000 },
  { name: 'Zed-0.11.0-universal.dmg', url: 'u/dmg', size: 204_800_000 },
  { name: 'Zed-0.11.0-universal.dmg.blockmap', url: 'u/dmg.blockmap', size: 210_000 },
  { name: 'Zed-0.11.0-x86_64.AppImage', url: 'u/appimage', size: 115_900_000 },
  { name: 'zed-darwin-arm64', url: 'u/cli-darwin-arm64', size: 69_700_000 },
  { name: 'zed-darwin-x64', url: 'u/cli-darwin-x64', size: 75_400_000 },
  { name: 'zed-linux-arm64', url: 'u/cli-linux-arm64', size: 99_900_000 },
  { name: 'zed-linux-x64', url: 'u/cli-linux-x64', size: 100_800_000 },
  { name: 'Zed-Setup-0.11.0.exe', url: 'u/exe', size: 96_000_000 },
  { name: 'Zed-Setup-0.11.0.exe.blockmap', url: 'u/exe.blockmap', size: 100_000 },
...
describe('pickDesktopAsset', () => {
  ...
  test('prefers the universal .dmg when per-arch builds also exist', () => {
    ...
    const perArch: ReleaseAsset[] = [
      { name: 'Zed-9.0.0-x64.dmg', url: 'u/intel', size: 1 },
      { name: 'Zed-9.0.0-universal.dmg', url: 'u/universal', size: 2 },
      { name: 'Zed-9.0.0-arm64.dmg', url: 'u/arm', size: 3 },
    ];
