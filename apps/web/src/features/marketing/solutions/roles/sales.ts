...
export const sales: RoleContent = {
  ...
  output: {
    ...
    caption:
      'Illustration. Northwind, Acme, Globex and Initech are placeholders — Zed never names a customer.',
    notes: [
      {
        id: 'draft',
  ...
  control: {
    ...
    rows: [
      ...
      },
      {
        ...
        v: 'A gate that errors out teaches an agent to route around it. A Zed gate holds the call open, so you answer while the session is still mid-task and it resumes from exactly where it stopped.',
      },
      {
        id: 'args',
      ...
      },
      {
        ...
        v: 'The sandbox carries one project-scoped Zed token and no third-party keys. Your CRM credential is decrypted server-side and attached to the outbound request. Turning a connector off takes effect on the next call — there is nothing in the sandbox to rotate.',
      },
      {
        id: 'audit',
