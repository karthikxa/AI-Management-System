...
export const people: RoleContent = {
  ...
  seoTitle: 'Zed for people and recruiting teams',
  seoDescription:
    'Interview kits, scheduling, onboarding runs and policy answers drawn from your own handbook. Zed does the coordination; a person makes every decision about a person.',
  ...
  control: {
    ...
    rows: [
      ...
      },
      {
        ...
        v: 'The sandbox carries one project-scoped Zed token and no third-party keys. Your applicant-system credential is decrypted server-side and attached to the outbound request, then thrown away.',
      },
      {
        id: 'sovereign',
        k: 'Where the data sits is your choice',
        v: 'Zed is open source and self-hostable: Zed Cloud, your own VPC, or your own on-prem network. If personal data may not leave your infrastructure, run the whole platform inside it. For deployment and compliance questions, talk to us rather than trusting a claim on a marketing page.',
      },
    ],
  },
