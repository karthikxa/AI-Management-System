...
function InstallFlow({ projectId, mode }: { projectId: string; mode: TeamsMode | undefined }) {
  ...
  return (
    <SectionCard
      title="Add Zed to Microsoft Teams"
      description="Install the Zed app into your Teams tenant, then bind this project to that tenant."
    >
        ...
        {managedAvailable ? (
          <label className="flex items-center gap-2 text-sm">
            ...
            <span className="text-muted-foreground">
              Bring your own Azure bot instead of the managed Zed bot
            </span>
          </label>
        ) : (
