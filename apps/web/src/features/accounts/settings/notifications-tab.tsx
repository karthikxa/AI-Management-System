              ...
              <div className="flex flex-col space-y-3">
                ...
                <div className="divide-y rounded-lg border">
                  ...
                  <NotificationToggle
                    ...
                    label="Questions"
                    description={tHardcodedUi.raw(
                      'componentsSettingsUserSettingsModal.line1127JsxAttrDescriptionWhenZedNeedsYourInputToContinue',
                    )}
                  ...
                  <NotificationToggle
                    ...
                    description={tHardcodedUi.raw(
                      'componentsSettingsUserSettingsModal.line1134JsxAttrDescriptionWhenZedNeedsPermissionToUseATool',
                    )}
