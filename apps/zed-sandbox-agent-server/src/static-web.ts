 ...
 * s6: the single `zed-agent` daemon owns the sandbox, so this runs
 ...
 * the session's credentials — `~/.config/zed-opencode.json` holds the
 ...
 * `http://127.0.0.1:3211` or `http://zed-sandbox:8000` — both unreachable
 ...
 *     the proxy strips (e.g. `https://api.zed.cloud/v1/p/<id>/3211` for
