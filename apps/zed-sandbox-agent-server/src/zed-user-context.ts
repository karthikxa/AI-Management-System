/**
 * Verify-only mirror of apps/api/src/shared/zed-user-context.ts.
 *
 * The API signs `X-Zed-User-Context` with the sandbox's ZED_TOKEN; the
 ...
 * apps/api/src/shared/zed-user-context.ts.
 */
export const ZED_SERVICE_CALL_HEADER = 'X-Zed-Service-Call'

interface ZedUserContext {
  userId: string
  sandboxId: string
