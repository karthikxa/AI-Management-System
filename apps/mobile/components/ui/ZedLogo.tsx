...
import ZedSymbolBlack from '@/assets/brand/zed-symbol.svg';
import ZedSymbolWhite from '@/assets/brand/Symbol.svg';
import LogomarkBlack from '@/assets/brand/Logomark-Black.svg';
import LogomarkWhite from '@/assets/brand/Logomark-White.svg';

interface ZedLogoProps extends Omit<ViewProps, 'style'> {
  size?: number;
...
export function ZedLogo({ 
  ...
  const SymbolComponent = color === 'dark' ? ZedSymbolWhite : ZedSymbolBlack;
