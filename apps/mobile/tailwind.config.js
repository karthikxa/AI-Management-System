  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        'zed-base': 'hsl(var(--zed-base))',
        'zed-blue': 'hsl(var(--zed-blue))',
        'zed-yellow': 'hsl(var(--zed-yellow))',
        'zed-orange': 'hsl(var(--zed-orange))',
        'zed-green': 'hsl(var(--zed-green))',
        'zed-purple': 'hsl(var(--zed-purple))',
        'zed-red': 'hsl(var(--zed-red))',
      },
      borderRadius: {
        lg: 'var(--radius)',
