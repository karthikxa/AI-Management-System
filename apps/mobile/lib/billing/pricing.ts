...
export interface PricingTier {
  ...
  revenueCatId?: string; // RevenueCat product identifier (e.g., 'zed_plus_monthly')
}
...
export const PRICING_TIERS: PricingTier[] = [
  {
    ...
    features: [
      ...
      '1 concurrent run',
      '1 Chat',
      'Basic Mode - Core Zed experience with basic autonomy',
    ],
    disabledFeatures: [
  ...
  },
  {
    ...
    features: [
      ...
      // '5 custom AI Workers - Create Zed Agents with custom Knowledge, Tools & Connections',
      ...
      'Zed Advanced mode - Strongest autonomy & decision-making capabilities',
    ],
    isPopular: true,
    buttonText: 'Get started',
    hidden: false,
    icon: Zap,
    revenueCatId: 'zed_plus',
  },
  {
    id: 'tier_6_50',
    name: 'Pro',
    ...
    features: [
      ...
      // '20 custom AI Workers - Create Zed Agents with custom Knowledge, Tools & Connections',
  ...
  },
  {
    ...
    features: [
      ...
      // '100 custom AI Workers - Create Zed Agents with custom Knowledge, Tools & Connections',
