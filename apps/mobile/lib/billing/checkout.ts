 ...
 * 
 * Note: The backend should return zed.com URLs that wrap/proxy Stripe,
...
// checkout URLs (should be zed.com masked URLs, not direct stripe.com)
// ============================================================================
 ...
 * a zed.com masked URL (not direct stripe.com for compliance)
 */
...
export async function openBillingPortal(returnUrl?: string): Promise<void> {
  ...
  try {
    ...
    const webBillingUrl = process.env.EXPO_PUBLIC_WEB_APP_URL 
      ...
      : 'https://www.zed.com/subscription';
