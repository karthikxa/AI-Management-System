 ...
 * and "Change requests" (Zed's native PR layer). Everything routes through the
 * `@zed/sdk` facade: `zed.project(id).git.*`, `.changeRequests.*`, and the
 * session-scoped `zed.session(id, sid).commit()`. No raw HTTP.
 *
