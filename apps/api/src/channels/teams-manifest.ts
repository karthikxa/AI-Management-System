...
const BOT_COMMANDS = [
  { title: '/help', description: 'Show what Zed can do' },
  { title: '/status', description: 'Show the effective project, agent and model' },
  { title: '/login', description: 'Connect your Zed account' },
...
const LONG_DESCRIPTION =
  'Zed brings a workforce of AI agents into Microsoft Teams. Add the bot to a chat or channel, @-mention it with a task, and an agent gets on it — working across your connected tools and replying right here as it goes, with live progress. Follow-ups stay in the same conversation. Managed by Zed · https://zed.com';
...
export function buildTeamsManifest(cfg: BuildTeamsManifestConfig): TeamsManifest {
  ...
  return {
    ...
    developer: {
      name: 'Zed',
      websiteUrl: 'https://zed.com',
      privacyUrl: 'https://zed.com/privacy',
      termsOfUseUrl: 'https://zed.com/terms',
    },
