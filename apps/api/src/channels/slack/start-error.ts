...
export function startErrorMessage(status: number | undefined, body: unknown): string {
  ...
  switch (code) {
    case 'UNKNOWN_SANDBOX_TEMPLATE':
      return "I couldn't start a session — the sandbox template configured for this project no longer exists. Update it in the project's Zed settings, then send your message again.";
    case 'ZED_URL_UNREACHABLE':
      return "I couldn't start a session — Zed couldn't reach the sandbox runtime just now. This is usually a brief infrastructure hiccup; give it a moment and send your message again.";
  ...
  switch (status) {
    case 400:
      return `I couldn't start a session — the request was rejected${shortDetail ? ` (${shortDetail})` : ''}. Check this channel's Zed settings with \`/zed\`, then send your message again.`;
    case 402:
    ...
    case 403:
      return "I couldn't start a session — this workspace doesn't have permission to run one here. Ask a Zed workspace admin to grant access, then send your message again.";
    case 404:
      return "I couldn't find this project to start a session — it may have been moved or deleted. Reconnect Zed to this channel with `/zed switch`, then try again.";
    case 409:
      return "I couldn't find a Zed account to run this session as. Connect your account with `/zed login`, then send your message again.";
    case 429:
    ...
    case 503:
    case 504:
      return "I couldn't start a session — Zed hit a temporary error. Give it a moment and send your message again — I'll reply right here.";
  }
