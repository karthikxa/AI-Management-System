import { connectors, connectorCalls, projectSessions, projects } from '@zed/db';
/**
 ...
 * route requires a signed-in Zed account and re-checks that the account may
    ...
    return c.json(
      verdict.reason === 'session_bound_caller'
        ...
        : verdict.reason === 'non_human_caller'
          ? {
              error: 'Sign in with a Zed account to review this approval',
              code: 'APPROVAL_REQUIRES_HUMAN',
            }
