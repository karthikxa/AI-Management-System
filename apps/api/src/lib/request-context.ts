...
export interface RequestContext {
  ...
  userId?: string;
  /** Zed account ID (set after auth middleware) */
  accountId?: string;
  /** User email (set after auth middleware) */
  userEmail?: string;
  /** Zed project ID (set by route middleware/handlers when known) */
  projectId?: string;
  /** Zed project session ID (set by route middleware/handlers when known) */
  sessionId?: string;
