 ...
 *   - First-request auth: validate a Bearer JWT / Zed token / `?token=`
...
// downstream `forwardToSandbox` can sign X-Zed-User-Context with the right
...
export async function handleSubdomainRequest(
  ...
  // X-Zed-User-Context signing, auto-wake retries, etc.
  //
