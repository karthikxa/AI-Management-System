 ...
 * as "the person who launched this session". In Zed-as-a-Backend every
 ...
 *
 * Only a Supabase-authenticated Zed user can resolve an approval. PATs,
...
export function mayResolveApproval(input: {
  ...
  // it — and in Zed-as-a-Backend that is the wrapper's own account, which is
