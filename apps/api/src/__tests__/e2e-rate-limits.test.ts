...
mock.module('../config', () => ({
  config: {
    ZED_CHECK_EMAIL_REQS_PER_MIN: 1,
    ZED_INVITE_ACCEPT_REQS_PER_MIN: 1,
    ZED_LLM_ROUTER_REQS_PER_MIN_FREE: 1,
    ZED_LLM_ROUTER_REQS_PER_MIN_PAID: 2,
    ZED_PROXY_REQS_PER_MIN: 1,
    ZED_PROJECT_WEBHOOK_REQS_PER_MIN: 1,
    ZED_PUBLIC_SESSION_SHARE_REQS_PER_MIN: 1,
  },
}));
