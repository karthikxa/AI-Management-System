...
variable "gateway_certificate_arn" {
  description = "ACM cert for the gateway ALB. Must cover the gateway origin hostname (gateway-<env>-ecs-fargate) for Cloudflare Full(strict). Default: the us-west-2 *.zed.com wildcard."
  type        = string
