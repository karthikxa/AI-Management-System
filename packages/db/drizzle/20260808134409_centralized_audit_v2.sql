...
--> statement-breakpoint
ALTER TABLE "zed"."audit_events" DROP CONSTRAINT "audit_events_account_id_accounts_account_id_fk";
--> statement-breakpoint
...
ALTER TABLE "zed"."audit_webhook_deliveries" ADD CONSTRAINT "audit_delivery_webhook_fk" FOREIGN KEY ("webhook_id") REFERENCES "zed"."audit_webhooks"("webhook_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "zed"."audit_webhook_deliveries" ADD CONSTRAINT "audit_delivery_event_fk" FOREIGN KEY ("event_id") REFERENCES "zed"."audit_events"("event_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
CREATE UNIQUE INDEX "idx_audit_webhook_delivery_event" ON "zed"."audit_webhook_deliveries" USING btree ("webhook_id","event_id");--> statement-breakpoint
CREATE INDEX "idx_audit_webhook_delivery_due" ON "zed"."audit_webhook_deliveries" USING btree ("status","next_attempt_at","locked_until");--> statement-breakpoint
CREATE INDEX "idx_audit_events_account_project_sequence" ON "zed"."audit_events" USING btree ("account_id","project_id","session_sequence");--> statement-breakpoint
CREATE INDEX "idx_audit_events_account_session_sequence" ON "zed"."audit_events" USING btree ("account_id","session_id","session_sequence");--> statement-breakpoint
CREATE INDEX "idx_audit_events_account_source_phase_time" ON "zed"."audit_events" USING btree ("account_id","authoritative_source","phase","occurred_at");--> statement-breakpoint
CREATE INDEX "idx_audit_events_account_client_source_time" ON "zed"."audit_events" USING btree ("account_id","client_reported_source","occurred_at") WHERE "zed"."audit_events"."client_reported_source" is not null;--> statement-breakpoint
CREATE UNIQUE INDEX "idx_audit_events_source_phase" ON "zed"."audit_events" USING btree ("source_ledger","source_record_id","phase",coalesce("source_revision", '')) WHERE "zed"."audit_events"."source_ledger" is not null and "zed"."audit_events"."source_record_id" is not null;--> statement-breakpoint
CREATE INDEX "idx_audit_events_action_pattern" ON "zed"."audit_events" USING btree ("action" text_pattern_ops);