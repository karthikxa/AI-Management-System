ALTER TABLE "zed"."chat_channel_bindings"
...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "zed"."chat_thread_participants" (
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "zed"."chat_thread_participants"
 ADD CONSTRAINT "chat_thread_participants_session_id_fkey"
 FOREIGN KEY ("session_id") REFERENCES "zed"."project_sessions"("session_id") ON DELETE CASCADE;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "idx_chat_thread_participants_thread_user"
ON "zed"."chat_thread_participants" USING btree ("platform","workspace_id","thread_id","platform_user_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_chat_thread_participants_session"
ON "zed"."chat_thread_participants" USING btree ("session_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_chat_thread_participants_user"
ON "zed"."chat_thread_participants" USING btree ("user_id");
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "zed"."chat_pending_auth_messages" (
...
--> statement-breakpoint
ALTER TABLE "zed"."chat_pending_auth_messages"
ADD COLUMN IF NOT EXISTS "slack_response_url" text;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "zed"."chat_pending_auth_messages"
 ADD CONSTRAINT "chat_pending_auth_messages_project_id_fkey"
 FOREIGN KEY ("project_id") REFERENCES "zed"."projects"("project_id") ON DELETE CASCADE;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_chat_pending_auth_messages_lookup"
ON "zed"."chat_pending_auth_messages" USING btree ("workspace_id","platform_user_id","expires_at");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_chat_pending_auth_messages_expiry"
ON "zed"."chat_pending_auth_messages" USING btree ("expires_at");
