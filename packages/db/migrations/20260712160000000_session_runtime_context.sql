...
-- server-owned ZED_SESSION_CONTEXT variable. Credentials and authorization
-- material intentionally do not belong in this table.

CREATE TABLE "zed"."project_session_runtime_contexts" (
  "session_id" text PRIMARY KEY
    REFERENCES "zed"."project_sessions"("session_id") ON DELETE CASCADE,
...
CREATE INDEX "idx_project_session_runtime_contexts_updated"
  ON "zed"."project_session_runtime_contexts" ("updated_at");

-- Down Migration

DROP TABLE IF EXISTS "zed"."project_session_runtime_contexts";
