...
CREATE TABLE IF NOT EXISTS "zed"."iam_resource_grants" (
...
CREATE UNIQUE INDEX IF NOT EXISTS "uq_iam_resource_grants"
  ON "zed"."iam_resource_grants" USING btree ("project_id", "resource_type", "resource_id", "principal_type", "principal_id");
--> statement-breakpoint

CREATE INDEX IF NOT EXISTS "idx_iam_resource_grants_project_type"
  ON "zed"."iam_resource_grants" USING btree ("project_id", "resource_type");
--> statement-breakpoint

CREATE INDEX IF NOT EXISTS "idx_iam_resource_grants_resource"
  ON "zed"."iam_resource_grants" USING btree ("project_id", "resource_type", "resource_id");
--> statement-breakpoint

CREATE INDEX IF NOT EXISTS "idx_iam_resource_grants_principal"
  ON "zed"."iam_resource_grants" USING btree ("principal_type", "principal_id");
--> statement-breakpoint

CREATE INDEX IF NOT EXISTS "idx_iam_resource_grants_account"
  ON "zed"."iam_resource_grants" USING btree ("account_id");

-- Down Migration

DROP TABLE IF EXISTS "zed"."iam_resource_grants";
