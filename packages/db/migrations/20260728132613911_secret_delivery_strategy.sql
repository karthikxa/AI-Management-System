...
-- `env`, /proc/<pid>/environ and /dev/shm/zed/agent-env.sh all read it back
...
CREATE TYPE "zed"."project_secret_handle_status" AS ENUM('active', 'superseded', 'revoked');--> statement-breakpoint
CREATE TYPE "zed"."project_secret_strategy" AS ENUM('runtime', 'egress', 'broker', 'denied');--> statement-breakpoint
CREATE TABLE "zed"."project_session_secret_handles" (
	...
	"status" "zed"."project_secret_handle_status" DEFAULT 'active' NOT NULL,
	"issued_at" timestamp with time zone DEFAULT now() NOT NULL,
	"expires_at" timestamp with time zone,
	"revoked_at" timestamp with time zone
);
--> statement-breakpoint
ALTER TABLE "zed"."project_secrets" ADD COLUMN "strategy" "zed"."project_secret_strategy" DEFAULT 'runtime' NOT NULL;--> statement-breakpoint
ALTER TABLE "zed"."project_secrets" ADD COLUMN "egress_policy" jsonb;--> statement-breakpoint
ALTER TABLE "zed"."project_secrets" ADD COLUMN "handle_prefix" varchar(48);--> statement-breakpoint
ALTER TABLE "zed"."project_secrets" ADD COLUMN "description" text;--> statement-breakpoint
ALTER TABLE "zed"."project_secrets" ADD COLUMN "rotated_at" timestamp with time zone;--> statement-breakpoint
ALTER TABLE "zed"."project_secrets" ADD COLUMN "strategy_locked" boolean DEFAULT false NOT NULL;--> statement-breakpoint
ALTER TABLE "zed"."projects" ADD COLUMN "secret_default_strategy" "zed"."project_secret_strategy" DEFAULT 'runtime' NOT NULL;--> statement-breakpoint
ALTER TABLE "zed"."project_session_secret_handles" ADD CONSTRAINT "project_session_secret_handles_project_id_fk" FOREIGN KEY ("project_id") REFERENCES "zed"."projects"("project_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "zed"."project_session_secret_handles" ADD CONSTRAINT "project_session_secret_handles_session_id_fk" FOREIGN KEY ("session_id") REFERENCES "zed"."project_sessions"("session_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "zed"."project_session_secret_handles" ADD CONSTRAINT "project_session_secret_handles_secret_id_fk" FOREIGN KEY ("secret_id") REFERENCES "zed"."project_secrets"("secret_id") ON DELETE cascade ON UPDATE no action;
