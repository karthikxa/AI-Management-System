...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE conname = 'app_deployments_source_session_id_project_sessions_session_id_f'
      AND conrelid = 'zed.app_deployments'::regclass
  ) THEN
    ALTER TABLE "zed"."app_deployments"
