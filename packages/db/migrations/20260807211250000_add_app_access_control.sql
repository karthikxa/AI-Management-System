-- Default-private access control for Zed Apps.
set lock_timeout = '2s';
set statement_timeout = '30s';

ALTER TABLE "zed"."apps"
...
CREATE TABLE "zed"."app_access_grants" (
  ...
  CONSTRAINT "app_access_grants_app_id_apps_app_id_fk"
    FOREIGN KEY ("app_id") REFERENCES "zed"."apps"("app_id") ON DELETE CASCADE
);

CREATE INDEX "app_access_grants_app_idx"
  ON "zed"."app_access_grants" ("app_id");

CREATE UNIQUE INDEX "app_access_grants_unique"
  ON "zed"."app_access_grants" ("app_id", "principal_type", "principal_id");
