...
INSERT INTO zed.project_secret_grants (secret_id, principal_type, principal_id)
SELECT ps.secret_id,
       g.principal_type::zed.secret_grant_principal,
       g.principal_id
FROM zed.iam_resource_grants g
JOIN zed.project_secrets ps
...
DELETE FROM zed.iam_resource_grants WHERE resource_type = 'secret';
